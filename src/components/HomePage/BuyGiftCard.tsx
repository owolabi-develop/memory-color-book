        ...
        <div className="bg-gray-200 rounded-2xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="bg-gray-200 flex flex-col justify-center p-6 sm:p-8 lg:p-10">
              ...
              <button className="inline-block border border-gray-800 text-gray-900 text-xs sm:text-sm font-medium px-5 sm:px-6 py-2 sm:py-2.5 rounded-full hover:bg-black hover:shadow-lg hover:scale-105 transition-all duration-300 w-fit hover:text-white ">
                Buy Gift Cards
              </button>
            </div>
          </div>
