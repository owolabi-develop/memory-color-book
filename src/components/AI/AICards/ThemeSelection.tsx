      ...
      <div className="text-center space-y-2 h-full">
        ...
        {/* Button Control */}
            ...
            return (
                    ...
                    className={`px-4 py-2 rounded-lg border text-sm font-medium transition flex items-center justify-between ${ isActive? "bg-black text-white border-black whitespace-nowrap": "bg-white text-gray-700 border-gray-300 hover:bg-gray-100 whitespace-nowrap"
                    }
                    `}
