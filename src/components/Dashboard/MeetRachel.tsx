        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-32 items-center">
          ...
          <div className="space-y-6 order-1 lg:order-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2">
              <button className="border border-gray-800 text-gray-900 text-xs sm:text-sm font-medium px-5 sm:px-6 py-2 sm:py-2.5 rounded-full hover:bg-gray-100 hover:shadow-lg hover:scale-105 transition-all duration-300 whitespace-nowrap">
